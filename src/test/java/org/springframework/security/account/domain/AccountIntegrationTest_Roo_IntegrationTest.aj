...
import org.springframework.security.account.domain.AccountDataOnDemand;
...
privileged aspect AccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void AccountIntegrationTest.testCountAccounts() {
        ...
        long count = org.springframework.security.account.domain.Account.countAccounts();
    ...
    public void AccountIntegrationTest.testFindAccount() {
        org.springframework.security.account.domain.Account obj = dod.getRandomAccount();
        ...
        obj = org.springframework.security.account.domain.Account.findAccount(id);
    ...
    public void AccountIntegrationTest.testFindAllAccounts() {
        ...
        java.util.List<org.springframework.security.account.domain.Account> result = org.springframework.security.account.domain.Account.findAllAccounts();
    ...
    public void AccountIntegrationTest.testFindAccountEntries() {
        ...
        java.util.List<org.springframework.security.account.domain.Account> result = org.springframework.security.account.domain.Account.findAccountEntries(0, (int) count);
    ...
    public void AccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.springframework.security.account.domain.Account merged = (org.springframework.security.account.domain.Account) obj.merge();
        obj.flush();
    ...
    public void AccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Account' failed to initialize correctly", dod.getRandomAccount());
        org.springframework.security.account.domain.Account obj = dod.getNewTransientAccount(Integer.MAX_VALUE);
    ...
    public void AccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Account' with identifier '" + id + "'", org.springframework.security.account.domain.Account.findAccount(id));
    }
